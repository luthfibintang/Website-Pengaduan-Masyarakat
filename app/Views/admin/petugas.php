...
<section class="section">
    ...
    <div class="section-header">
        <h1>Manage user Petugas</h1>
        <div class="section-header-button">
        <a href="<?= base_url(); ?>/admin/tambahpetugas" class="btn btn-primary"><i class="fas fa-plus"></i></a>
        </div>
        ...
        <table class="table table-striped" id="datapengaduan">
            ...
            <?php $page = isset($_GET['page']) ? $_GET['page'] : 1;
                ...
                <td>
                    ...
                    <form action="<?= base_url('admin/deleteptg/' . $user->userid); ?>" method="post" class="d-inline">
                    <?= csrf_field(); ?>
