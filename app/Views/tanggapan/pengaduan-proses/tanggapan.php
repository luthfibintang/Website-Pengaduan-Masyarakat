...
<div class="section-header-back">
    <a href="<?= base_url('/pengaduan/proses_detail/' . $pengaduan->id_pengaduan); ?>" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
</div>
...
<div class="row">
    ...
    <?= view('Myth\Auth\Views\_message_block') ?>
        ...
        <form action="<?= base_url('') ?>/tanggapan/tanggapi" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <input type="hidden" name="id_pengaduan" value="<?= $pengaduan->id_pengaduan; ?>">
            <input type="hidden" name="kategori" value="<?= $pengaduan->id_kategori; ?>" >
            <div class="mb-3">
