...
<section class="section">
    ...
    <!-- Page Heading -->
    <h1>Detail Pengaduan Terverifikasi</h1>
    ...
    <form action="<?= base_url(); ?>/pengaduan/prosesall" method="post">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        ...
                        <button class="btn btn-warning mb-3" name="btnproses" type="submit">Proses</button>
                    </div>
                </div>
                <div class="card-body">
